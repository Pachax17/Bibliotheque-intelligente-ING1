...
public class UtilisateurController {
    ...
    public String afficherFormulaireModification(@PathVariable Long id, Model model) {
        ...
        if (utilisateur.isPresent()) {
            ...
            return "modifier-utilisateur"; // View modifier-utilisateur.html
        } else {
    ...
    public String modifierUtilisateur(@PathVariable Long id, @ModelAttribute("utilisateur") Utilisateur modif) {
        utilisateurService.mettreAJourUtilisateur(id, modif);
