...
public class EmailService {
    ...
    /**
     * Envoie un e-mail au rôle administrateur pour une demande de promotion
     */
    public void envoyerEmailAdmin(String destinataire, String sujet, String contenu) {
        new Thread(() -> {
            try {
                SimpleMailMessage message = new SimpleMailMessage();
                message.setTo(destinataire);
                ...
                System.err.println("❌ Erreur lors de l'envoi d'un email à l'admin : " + e.getMessage());
            }
        }).start();
    }
}
